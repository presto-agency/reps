...
//        $this->chat_helper = new ChatViewHelper;
    ...
    {
        $messages = PublicChat::select('id', 'user_id', 'user_name', 'message', 'is_hidden', 'to', 'file_path', 'imo', 'created_at')->with('user.country')
...
//        $country_flag = ($msg->user->country_id) ? $countries[$msg->user->country_id]->flag : '';
        $country_flag = ($msg->user->country) ? $msg->user->country->flag : '';
