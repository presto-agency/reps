...
CKEDITOR.plugins.add( 'hkemoji', {
    ...
    init: function(editor) {
        ...
        var pluginDirectory = '/storage/chat/';
        editor.config.smiley_path =  pluginDirectory ;
