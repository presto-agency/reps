 ...
 * Generated for Laravel 6.5.2 on 2020-01-17.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Cache {
        ...
        {
            return \Illuminate\Cache\RedisStore::lock($name, $seconds, $owner);
        }
        ...
        {
            return \Illuminate\Cache\RedisStore::restoreLock($name, $owner);
        }
    ...
    class Redis {
        ...
        {
            \Illuminate\Redis\RedisManager::setDriver($driver);
        }
        ...
        public static function extend($driver, $callback)
        {
            return \Illuminate\Redis\RedisManager::extend($driver, $callback);
        }
...
namespace Facade\Ignition\Facades { 
    ...
    class Flare {
        ...
        public static function getMiddleware()
        {
            return \Facade\FlareClient\Flare::getMiddleware();
        }
        ...
        {
            return \Facade\FlareClient\Flare::registerFlareHandlers();
        }
        ...
        {
            return \Facade\FlareClient\Flare::registerExceptionHandler();
        }
        ...
        {
            return \Facade\FlareClient\Flare::registerErrorHandler();
        }
        ...
        {
            return \Facade\FlareClient\Flare::registerMiddleware($callable);
        }
        ...
        {
            return \Facade\FlareClient\Flare::getMiddlewares();
        }
        ...
        {
            return \Facade\FlareClient\Flare::glow($name, $messageLevel, $metaData);
        }
        ...
        {
            return \Facade\FlareClient\Flare::handleException($throwable);
        }
        ...
        {
            return \Facade\FlareClient\Flare::handleError($code, $message, $file, $line);
        }
        ...
        {
            return \Facade\FlareClient\Flare::applicationPath($applicationPath);
        }
        ...
        {
            return \Facade\FlareClient\Flare::report($throwable, $callback);
        }
        ...
        {
            return \Facade\FlareClient\Flare::reset();
        }
        ...
        {
            return \Facade\FlareClient\Flare::anonymizeIp();
        }
        ...
        {
            return \Facade\FlareClient\Flare::stage($stage);
        }
        ...
        {
            return \Facade\FlareClient\Flare::messageLevel($messageLevel);
        }
        ...
        {
            return \Facade\FlareClient\Flare::getGroup($groupName, $default);
        }
        ...
        {
            return \Facade\FlareClient\Flare::context($key, $value);
        }
