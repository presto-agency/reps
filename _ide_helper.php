...
namespace DaveJamesMiller\Breadcrumbs\Facades {
    ...
    class Breadcrumbs {
        ...
        {
                        /** @var BreadcrumbsManager $instance */
         ...
         * @throws UnnamedRouteException if no name is given and the current route
         *     doesn't have an associated name.
         * @throws InvalidBreadcrumbException if the name is (or any ancestor names
         *     are) not registered.
         * @static
         */
        ...
        public static function macro($name, $macro)
        {
                        BreadcrumbsManager::macro($name, $macro);
        }
        ...
        public static function mixin($mixin, $replace = true)
        {
                        BreadcrumbsManager::mixin($mixin, $replace);
        }
        ...
        public static function hasMacro($name)
        {
                        return BreadcrumbsManager::hasMacro($name);
        }
...
namespace Collective\Html {
    ...
    class FormFacade {
        ...
        public static function mixin($mixin, $replace = true)
        {
                        FormBuilder::mixin($mixin, $replace);
        }
    ...
    class HtmlFacade {
        ...
        public static function mixin($mixin, $replace = true)
        {
                        HtmlBuilder::mixin($mixin, $replace);
        }
...
namespace KodiCMS\Assets\Facades {
    ...
    use CachingIterator;
    use Illuminate\Support\Collection;
    use Illuminate\Support\iterable;
    use Illuminate\Support\LazyCollection;
    use InvalidArgumentException;
    use KodiCMS\Assets\AssetsInterface;
    use KodiCMS\Assets\MetaDataInterface;
    use KodiCMS\Assets\Package;
    use KodiCMS\Assets\PackageInterface;
    use KodiCMS\Assets\SocialMediaTagsInterface;
    use ReflectionException;
    ...
    class PackageManager {
        ...
        {
                        /** @var \KodiCMS\Assets\PackageManager $instance */
                        return $instance->add($package);
        }
        ...
        public static function countBy($callback = null)
        {
            //Method inherited from \Illuminate\Support\Collection
                        /** @var \KodiCMS\Assets\PackageManager $instance */
                        return $instance->countBy($callback);
        }
    ...
    class Meta {
        ...
        public static function assets()
        {
            //Method inherited from \KodiCMS\Assets\Meta
                        /** @var \SleepingOwl\Admin\Templates\Meta $instance */
        ...
        public static function setMetaDescription($description)
        {
            //Method inherited from \KodiCMS\Assets\Meta
                        /** @var \SleepingOwl\Admin\Templates\Meta $instance */
                        return $instance->setMetaDescription($description);
        }
        ...
        public static function setMetaKeywords($keywords)
        {
            //Method inherited from \KodiCMS\Assets\Meta
                        /** @var \SleepingOwl\Admin\Templates\Meta $instance */
                        return $instance->setMetaKeywords($keywords);
        }
        ...
        public static function setMetaRobots($robots)
        {
            //Method inherited from \KodiCMS\Assets\Meta
                        /** @var \SleepingOwl\Admin\Templates\Meta $instance */
                        return $instance->setMetaRobots($robots);
        }
        ...
        public static function addSocialTags($socialTags)
        {
            //Method inherited from \KodiCMS\Assets\Meta
                        /** @var \SleepingOwl\Admin\Templates\Meta $instance */
                        return $instance->addSocialTags($socialTags);
        }
        ...
        public static function addMeta($attributes, $group = null)
        {
            //Method inherited from \KodiCMS\Assets\Meta
                        /** @var \SleepingOwl\Admin\Templates\Meta $instance */
                        return $instance->addMeta($attributes, $group);
        }
        ...
        public static function setFavicon($url, $rel = 'shortcut icon', $type = 'image/x-icon')
        {
            //Method inherited from \KodiCMS\Assets\Meta
                        /** @var \SleepingOwl\Admin\Templates\Meta $instance */
                        return $instance->setFavicon($url, $rel, $type);
        }
        ...
        public static function addTagToGroup($handle, $content, $params = array(), $dependency = null)
        {
            //Method inherited from \KodiCMS\Assets\Meta
                        /** @var \SleepingOwl\Admin\Templates\Meta $instance */
                        return $instance->addTagToGroup($handle, $content, $params, $dependency);
        }
        ...
        public static function removeFromGroup($handle = null)
        {
            //Method inherited from \KodiCMS\Assets\Meta
                        /** @var \SleepingOwl\Admin\Templates\Meta $instance */
                        return $instance->removeFromGroup($handle);
        }
...
namespace SleepingOwl\Admin\Facades {
    ...
    use KodiComponents\Navigation\PageInterface;
    use ReflectionException;
    use SleepingOwl\Admin\AdminInterface;
    use SleepingOwl\Admin\Collection;
    ...
    use SleepingOwl\Admin\Display\Column\Filter;
    use SleepingOwl\Admin\Display\Column\Filter\Range;
    use SleepingOwl\Admin\Display\Column\Gravatar;
    ...
    use SleepingOwl\Admin\Display\Filter\FilterRelated;
    use SleepingOwl\Admin\Display\Filter\FilterScope;
    ...
    use SleepingOwl\Admin\Form\Element\DateRange;
    ...
    use SleepingOwl\Admin\Form\Element\TextAddon;
    ...
    use SleepingOwl\Admin\Form\Related\Forms\ManyToMany;
    use SleepingOwl\Admin\ModelCollection;
    use SleepingOwl\Admin\ModelConfigurationInterface;
    use SleepingOwl\Admin\Navigation\Page;
    use SleepingOwl\Admin\TemplateInterface;
    use SleepingOwl\Admin\Templates\MetaInterface;
    use SleepingOwl\Admin\Templates\NavigationInterface;
    use SleepingOwl\Admin\Templates\TemplateDefault;
    use SleepingOwl\Admin\Widgets\Factory;
    ...
    use SleepingOwl\Admin\Wysiwyg\WysiwygEditorInterface;
    use SleepingOwl\Admin\Wysiwyg\WysiwygFilterInterface;
    ...
    class WysiwygManager {
        ...
        public static function getDefaultEditorId()
        {
                        ...
                        return $instance->getDefaultEditorId();
        }
        ...
        {
                        /** @var Manager $instance */
                        return $instance->register($editorId, $filter, $name);
        }

        /**
         *
         *
         * @return \SleepingOwl\Admin\Wysiwyg\Collection|WysiwygEditorInterface[]
         * @static
         */
        ...
        {
                        /** @var Manager $instance */
                        return $instance->getEditor($editorId);
        }
        ...
        {
                        /** @var Manager $instance */
                        return $instance->loadDefaultEditor();
        }
        ...
        {
                        /** @var Manager $instance */
                        return $instance->loadEditor($editorId);
        }
        ...
        {
                        /** @var Manager $instance */
                        return $instance->applyFilter($editorId, $text);
        }
        ...
        {
                        /** @var Manager $instance */
                        return $instance->getFiltersList();
        }
     ...
     *
     *
     * @method static ErrorMessages addError($text)
     * @method static InfoMessages addInfo($text)
     * @method static SuccessMessages addSuccess($text)
     * @method static WarningMessages addWarning($text)
     */
    class MessageStack {
    ...
    class Admin {
        ...
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
        ...
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
                        return $instance->registerModel($class, $callback);
        }
         ...
         * @return \SleepingOwl\Admin\Admin
         * @static
         */
        public static function register($model)
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
                        return $instance->register($model);
        }
        ...
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
                        return $instance->registerSections($sections);
        }
        ...
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
                        return $instance->getMissedSections();
        }
        ...
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
                        return $instance->setModel($class, $model);
        }
        ...
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
                        return $instance->getModel($class);
        }
        ...
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
                        return $instance->hasModel($class);
        }
        ...
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
                        return $instance->addMenuPage($class, $priority);
        }
        ...
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
                        return $instance->view($content, $title);
        }
        ...
        {
                        /** @var \SleepingOwl\Admin\Admin $instance */
                        return $instance->scriptVariables();
        }
    ...
    class Template {
        ...
        {
                        /** @var TemplateDefault $instance */
                        return $instance->getViewNamespace();
        }
        ...
        public static function makeTitle($title, $separator = '|')
        {
            //Method inherited from \SleepingOwl\Admin\Templates\Template
                        /** @var TemplateDefault $instance */
                        return $instance->makeTitle($title, $separator);
        }
        ...
        public static function getViewPath($view)
        {
            //Method inherited from \SleepingOwl\Admin\Templates\Template
                        /** @var TemplateDefault $instance */
                        return $instance->getViewPath($view);
        }
        ...
        public static function renderBreadcrumbs($key)
        {
            //Method inherited from \SleepingOwl\Admin\Templates\Template
                        /** @var TemplateDefault $instance */
                        return $instance->renderBreadcrumbs($key);
        }
        ...
        public static function renderNavigation()
        {
            //Method inherited from \SleepingOwl\Admin\Templates\Template
                        /** @var TemplateDefault $instance */
                        return $instance->renderNavigation();
        }
        ...
        public static function renderMeta($title)
        {
            //Method inherited from \SleepingOwl\Admin\Templates\Template
                        /** @var TemplateDefault $instance */
                        return $instance->renderMeta($title);
        }
    ...
    class Navigation {
        ...
        {
                        /** @var \SleepingOwl\Admin\Navigation $instance */
        ...
        {
                        /** @var \SleepingOwl\Admin\Navigation $instance */
                        return $instance->setAliasesId($pages);
        }
        ...
        public static function setCurrentUrl($url)
        {
            //Method inherited from \KodiComponents\Navigation\Navigation
                        /** @var \SleepingOwl\Admin\Navigation $instance */
                        return $instance->setCurrentUrl($url);
        }
        ...
        public static function setFromArray($navigation)
        {
            //Method inherited from \KodiComponents\Navigation\Navigation
                        /** @var \SleepingOwl\Admin\Navigation $instance */
                        return $instance->setFromArray($navigation);
        }
        ...
        public static function setAccessLogic($accessLogic)
        {
            //Method inherited from \KodiComponents\Navigation\Navigation
                        /** @var \SleepingOwl\Admin\Navigation $instance */
                        return $instance->setAccessLogic($accessLogic);
        }
        ...
        public static function getAccessLogic()
        {
            //Method inherited from \KodiComponents\Navigation\Navigation
                        /** @var \SleepingOwl\Admin\Navigation $instance */
                        return $instance->getAccessLogic();
        }
        ...
        public static function filterByAccessRights()
        {
            //Method inherited from \KodiComponents\Navigation\Navigation
                        /** @var \SleepingOwl\Admin\Navigation $instance */
                        return $instance->filterByAccessRights();
        }
        ...
        public static function filterEmptyPages()
        {
            //Method inherited from \KodiComponents\Navigation\Navigation
                        /** @var \SleepingOwl\Admin\Navigation $instance */
                        return $instance->filterEmptyPages();
        }
     ...
     *
     *
     * @method static Action action($name, $title = null)
     * @method static \SleepingOwl\Admin\Display\Column\Checkbox checkbox($label = null)
     * @method static Control control($label = null)
     * @method static Count count($name, $label = null)
     ...
     * @method static Filter filter($name, $label = null)
     * @method static \SleepingOwl\Admin\Display\Column\Image image($name, $label = null)
     * @method static Gravatar gravatar($name, $label = null)
     * @method static Lists lists($name, $label = null)
     * @method static Order order()
     * @method static \SleepingOwl\Admin\Display\Column\Text text($name, $label = null)
     * @method static Link link($name, $label = null)
     * @method static RelatedLink relatedLink($name, $label = null)
     * @method static Email email($name, $label = null)
     * @method static TreeControl treeControl()
     * @method static Url url($name, $label = null)
     */
    class TableColumn {
        ...
        public static function registerRoutes($router)
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        DisplayColumnFactory::registerRoutes($router);
        }
        ...
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        /** @var DisplayColumnFactory $instance */
                        return $instance->bind($alias, $class);
        }
        ...
        public static function add($alias, $class)
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        /** @var DisplayColumnFactory $instance */
                        return $instance->add($alias, $class);
        }
        ...
        public static function register($classes)
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        /** @var DisplayColumnFactory $instance */
                        return $instance->register($classes);
        }
        ...
        public static function hasAlias($alias)
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        /** @var DisplayColumnFactory $instance */
                        return $instance->hasAlias($alias);
        }
        ...
        public static function makeClass($alias, $arguments)
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        /** @var DisplayColumnFactory $instance */
                        return $instance->makeClass($alias, $arguments);
        }
     ...
     * @method static Datetime datetime($name, $label = null)
     */
    class TableColumnEditable {
        ...
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        DisplayColumnEditableFactory::registerRoutes($router);
        }
         ...
         * @param string $alias
         * @param string $class
         * @return DisplayColumnEditableFactory
         * @static
         */
        public static function bind($alias, $class)
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        /** @var DisplayColumnEditableFactory $instance */
                        return $instance->bind($alias, $class);
        }
     ...
     *
     *
     * @method static Filter\Text text()
     * @method static Filter\Date date()
     * @method static Filter\Select select()
     * @method static Range range()
     * @method static Filter\DateRange daterange()
     */
    class TableColumnFilter {
        ...
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        DisplayColumnFilterFactory::registerRoutes($router);
        }
         ...
         * @param string $alias
         * @param string $class
         * @return DisplayColumnFilterFactory
         * @static
         */
        public static function bind($alias, $class)
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        /** @var DisplayColumnFilterFactory $instance */
                        return $instance->bind($alias, $class);
        }
     ...
     *
     *
     * @method static FilterCustom custom($name, string|Closure|null $title = null, Closure $callback = null)
     * @method static FilterField field($name, string|Closure|null $title = null)
     * @method static FilterRelated related($name, string|Closure|null $title = null)
     * @method static FilterScope scope($name, string|Closure|null $title = null)
     */
    class DisplayFilter {
        ...
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        DisplayFilterFactory::registerRoutes($router);
        }
         ...
         * @param string $alias
         * @param string $class
         * @return DisplayFilterFactory
         * @static
         */
        public static function bind($alias, $class)
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        /** @var DisplayFilterFactory $instance */
                        return $instance->bind($alias, $class);
        }
     ...
     *
     *
     * @method static FormDefault form(array $elements = [])
     * @method static FormElements elements(array $elements = [])
     * @method static FormTabbed tabbed(array $elements = [])
     * @method static FormPanel panel(array $elements = [])
     */
    class Form {
        ...
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        FormFactory::registerRoutes($router);
        }
     ...
     * @method static Images images($name, $label = null)
     * @method static File file($name, $label = null)
     * @method static Files files($name, $label = null)
     * @method static Time time($name, $label = null)
     * @method static Date date($name, $label = null)
     * @method static DateRange daterange($name, $label = null)
     ...
     * @method static Select select($name, $label = null, array|Model|string $options = [])
     * @method static MultiSelect multiselect($name, $label = null, array|Model|string $options = [])
     * @method static SelectAjax selectajax($name, $label = null)
     * @method static MultiSelectAjax multiselectajax($name, $label = null)
     * @method static DependentSelect dependentselect($name, $label = null, array $depends = [])
     * @method static MultiDependentSelect multidependentselect($name, $label = null, array $depends = [])
     * @method static Columns columns(array $columns = [])
     * @method static Hidden hidden($name)
     * @method static Custom custom(Closure $callback = null)
     * @method static Html html($html)
     * @method static View view($view, array $data, Closure $callback = null)
     ...
     * @method static Radio radio($name, $label = null)
     * @method static Wysiwyg wysiwyg($name, $label = null, $editor = null)
     * @method static Upload upload($name, $label = null)
     * @method static Number number($name, $label = null)
     * @method static HasMany hasMany(string $relationName, array $elements)
     * @method static ManyToMany manyToMany(string $relationName, array $elements)
     * @method static BelongsTo belongsTo(string $relationName, array $elements)
     */
    class FormElement {
        ...
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        FormElementFactory::registerRoutes($router);
        }
        ...
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        /** @var FormElementFactory $instance */
                        return $instance->bind($alias, $class);
        }
     ...
     *
     *
     * @method static DisplayDatatables datatables()
     * @method static DisplayDatatablesAsync datatablesAsync()
     * @method static DisplayTab tab(Renderable $display, string $label = null, string $icon = null, $badge = null)
     * @method static DisplayTabbed tabbed(Closure|array $tabs = null)
     * @method static DisplayTable table()
     * @method static DisplayTree tree(TreeTypeInterface $type = null)
     * @method static Page page($class)
     */
    class Display {
        ...
        {
            //Method inherited from \SleepingOwl\Admin\AliasBinder
                        DisplayFactory::registerRoutes($router);
        }
    ...
    class Widgets {
        ...
        {
                        /** @var WidgetsRegistry $instance */
                        return $instance->placeWidgets($factory);
        }
        ...
        {
                        /** @var WidgetsRegistry $instance */
                        return $instance->makeWidget($widget);
        }
        ...
        {
                        /** @var WidgetsRegistry $instance */
                        return $instance->createClassWidget($widget);
        }
...
namespace  {
    ...
    use SleepingOwl\Admin\Facades\TableColumnEditable;
    use SleepingOwl\Admin\Facades\TableColumnFilter;
    use SleepingOwl\Admin\Facades\Template;
    use SleepingOwl\Admin\Facades\Widgets;
    ...
    class checkFile extends PathHelper {}
    ...
    class MessagesStack extends MessageStack {}

    class AdminSection extends Admin {}

    class AdminTemplate extends Template {}

    class AdminNavigation extends Navigation {}

    class AdminColumn extends TableColumn {}

    class AdminColumnEditable extends TableColumnEditable {}

    class AdminColumnFilter extends TableColumnFilter {}

    class AdminDisplayFilter extends DisplayFilter {}

    class AdminForm extends \SleepingOwl\Admin\Facades\Form {}

    class AdminFormElement extends FormElement {}

    class AdminDisplay extends Display {}

    class AdminWidgets extends Widgets {}
