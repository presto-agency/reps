    ...
    <div class="detailed-news__card card night_modal night_text border_shadow">
        <div class="card-body__items">
            ...
            <div class="card-body__items-wrap">
                ...
                @endphp
                <a href="{{ $modal }}" class="items__like modal_like-diselike night_text positive-vote vote-replay-up" data-toggle="modal" data-rating="1"
                ...
                <a href="{{ $modal }}" class="items__dislike modal_like-diselike negative-vote vote-replay-down" data-toggle="modal" data-rating="-1"
                   data-route="{{route('forum.topic.set_rating',['id'=>$news->id])}}">
