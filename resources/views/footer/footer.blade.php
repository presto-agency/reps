    ...
    <div class="container">
        <div class="row">
            ...
            <div class="footer__our-birthday col-xl-2 col-lg-2 mt-lg-0 col-md-6 col-sm-12 mt-4">
                ...
                <div class="row">
                    <div class="col-6">
                        <p class="our-birthday__nickname">Rus_Brain</p>
                        <p class="our-birthday__nickname">FR123wer</p>
                        <p class="our-birthday__nickname">Johr_ren</p>
                        <p class="our-birthday__nickname">monureR</p>
                    </div>
                    <div class="col-6">
                        <p class="our-birthday__nickname">monureR</p>
                        <p class="our-birthday__nickname">Rus_Brain</p>
