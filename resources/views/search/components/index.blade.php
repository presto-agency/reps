<div class="gocu-replays border_shadow">
    ...
    @isset($searchResult['Replay'])
        @foreach($searchResult['Replay'] as $item)
...
{{--    @if($visible_title)--}}
        <div class="breaking-news__title">
            ...
            <p class="title__text ">Все новости</p>
        </div>
{{--    @endif--}}

    @isset($searchResult['ForumTopic'])
        @foreach($searchResult['ForumTopic'] as $single_news)
