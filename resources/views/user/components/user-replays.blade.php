<div class="user-replays">
    <div class="user-replays__title">
    ...
    <div class="user-replays__button">
        <button class="button button__download-more">Ещё</button>
    </div>
</div>
