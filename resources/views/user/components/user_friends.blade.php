                    ...
                    <div class="row row_users">
                        ...
                        <div class="col-3 block_action">
                            <a href="{{route('user.remove_friend',['id' => $item->id])}}">
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 729.837 729.838" style="enable-background:new 0 0 729.837 729.838;"
                                     xml:space="preserve">
