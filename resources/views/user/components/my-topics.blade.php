<div class="my-topics forum-topics">
    ...
    <div class="my-topics__accordion">
        ...
        <button class="accordion-button">Общий</button>
        <div class="panel">
        ...
        <button class="accordion-button">Репортажи</button>
        <div class="panel">
            <div class="panel__wrap">
                <div class="panel__header">
                    <div class="header__items">
        ...
        <button class="accordion-button">Чемпионаты</button>
        <div class="panel">
            <div class="panel__wrap">
                <div class="panel__header">
                    <div class="header__items">
