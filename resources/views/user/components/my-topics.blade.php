<div class="my-topics forum-topics border_shadow">
    ...
    <div class="my-topics__accordion">
        <button class="accordion-button change_gray night_text">Общий</button>
        <div class="panel night_modal">
            <div class="panel__wrap">
                <div class="panel__header">
                    <div class="header__items">
                        <a class="items__link" href="#">Общий</a>
                        <span>|</span>
                ...
                <div class="panel__footer">
                    <div class="footer__item">
                        <button class="items__items item__watch">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 515.556 515.556" viewBox="0 0 515.556 515.556"><path d="m257.778 64.444c-119.112 0-220.169 80.774-257.778 193.334 37.609 112.56 138.666 193.333 257.778 193.333s220.169-80.774 257.778-193.333c-37.609-112.56-138.666-193.334-257.778-193.334zm0 322.223c-71.184 0-128.889-57.706-128.889-128.889 0-71.184 57.705-128.889 128.889-128.889s128.889 57.705 128.889 128.889c0 71.182-57.705 128.889-128.889 128.889z"/><path d="m303.347 212.209c25.167 25.167 25.167 65.971 0 91.138s-65.971 25.167-91.138 0-25.167-65.971 0-91.138 65.971-25.167 91.138 0"/></svg>
                            <span>168</span>
                        </button>
                    ...
                    <div class="footer__item">
                        ...
                        <a class="rate" href="#">рейтинг лист</a>
                    </div>
        ...
        <button class="accordion-button change_gray night_text">Репортажи</button>
        <div class="panel night_modal">
            <div class="panel__wrap">
                <div class="panel__header">
                    <div class="header__items">
        ...
        <button class="accordion-button change_gray night_text">Чемпионаты</button>
        <div class="panel night_modal">
            <div class="panel__wrap">
                <div class="panel__header">
                    <div class="header__items">
