        ...
        <div class="userInfo_block">
            <div class="row">
                <div class="col-xl-4 col-4 container_img">
                    <img src="http://reps.dev.devloop.pro/images/userAvatar3.png" alt="user_avatar">
                </div>
                <div class="col-xl-8 col-8 container_information">
                    ...
                    <div class="information_block">
                            ...
                            <div class="right_block"><span>PXZerg 16828 pts</span></div>
                    </div>
                    <div class="information_block">
                        <div class="left_block"><span>ДР:</span></div>
                        <div class="right_block"><span>01.06.2019</span></div>
                    </div>
                    <div class="information_block">
                    ...
                    <div class="information_block">
                        ...
                        <div class="right_block"><span>Zerg</span></div>
                    </div>
                    <div class="information_block">
                        <div class="left_block"><span>Репутация:</span></div>
                        <div class="right_block"><span class="blue">675 кг</span></div>
                    </div>
                </div>
                <button class="button button__download-more">ДОБАВИТЬ</button>
                <button class="button button__download-more">НАПИСАТЬ</button>
                <button class="button button__download-more">ИГНОРИРОВАТЬ</button>
            </div>
        </div>
                ...
                <div class="col-xl-6 col-6 container_right">
                    ...
                    <div class="wrapper_information">
                        <div class="block_inform">
                            ...
                            <div class="right_block"><span class="blue">1653</span></div>
                        </div>
                        <div class="block_inform">
                            <div class="left_block"><span>Посты:</span></div>
                            <div class="right_block"><span class="blue">14972</span></div>
                        </div>
                        <div class="block_inform">
                            <div class="left_block"><span>Госу реплеи:</span></div>
                            <div class="right_block"><span class="blue">161</span></div>
                        </div>
                        <div class="block_inform">
                            <div class="left_block"><span>Пользовательские реплеи:</span></div>
                            <div class="right_block"><span class="blue">15</span></div>
                        </div>
                    </div>
                    <div class="title_top_userProfile">
                    ...
                    <div class="wrapper_contacts">
                        <div class="block_contact">
                            ...
                            <div class="right_block"><span>Скрыт</span></div>
                        </div>
                        <div class="block_contact">
                            <div class="left_block"><span>Сайт:</span></div>
                            <div class="right_block"><a href="#"><span class="small">http://patyrykin.net</span></a></div>
                        </div>
                        <div class="block_contact">
                            <div class="left_block"><span>Discord:</span></div>
                            <div class="right_block"><span>Rus_Brain#6290</span></div>
                        </div>
                        <div class="block_contact">
                            <div class="left_block"><span>Skype:</span></div>
                            <div class="right_block"><span>Rrus_brain</span></div>
                        </div>
                        <div class="block_contact">
                            <div class="left_block"><span>Подпись:</span></div>
                            <div class="right_block"><span class="blue">rus_brain</span></div>
                        </div>
                        <img src="http://reps.loc/images/Layer_26.png" alt="avatar" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
