                    ...
                    <div class="panel__wrap">
                        <div class="panel__header">
                            <div class="header__items">
                                <a class="items__link" href="#">Общие</a>
                                <span>|</span>
                            ...
                            <div class="header__items">
                                ...
                                <p class="items__info">{{$items->created_at->format('h:m d:m:Y')}}</p>
                                <p class="items__info info">#{{$items->id}}</p>
                            </div>
                        </div>
                        <div class="panel__body">
                            <p class="body__comment night_text">{!! $items->content !!}</p>
                        </div>
	                    ...
	                    <path
                            ...
                            h278.6c37.6,0,62.2-42,43.7-74.7c22.1-14.2,29.7-44,16.7-66.9c22.1-14.2,29.7-44,16.7-66.9C527.6,235.2,514.8,174.8,470.3,167.3z"></path>
                                    ...
                                    <span>{{$items->positive_count}}</span>
                                </button>
                                <button class="items__items item__dislike">
                                    ...
                                    <span>{{$items->negative_count}}</span>
                                </button>
                                <a class="rate" href="{{route('user-rating-list.index')}}">рейтинг лист</a>
                            </div>
                            <div class="footer__item">
                                <a class="item__later" href="{{route('topic.show',['topic'=>$items->id])}}">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         xmlns:xlink="http://www.w3.org/1999/xlink"
