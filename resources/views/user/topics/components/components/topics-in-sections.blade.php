@if(isset($forumSectionsTopics) && $forumSectionsTopics->isNotEmpty())
    @foreach($forumSectionsTopics as $item)
        <div class="panel__wrap">
            <div class="panel__header">
                <div class="header__items">
                    @if(!empty($item->forumSection))
                        <a class="items__link" href="{{route('forum.show',['forum'=>$item->forumSection->id])}}">
                            {{$item->forumSection->title}}</a>
                    @endif
                    <span>{{__('|')}}</span>
                    <a class="items__link" href="{{route('topic.show',['topic'=>$item->id])}}">
                        {{ clean($item->title) }}</a>
                </div>
                <div class="header__items">
            ...
            <div class="panel__footer">
                ...
                <div class="footer__item">
                    ...
                    <a class="rate" href="{{route('forum.topic.get_rating',['id' => $item->id])}}">
                        {{__('Рейтинг лист')}}</a>
                </div>
                <div class="footer__item">
                    <a class="item__later"
