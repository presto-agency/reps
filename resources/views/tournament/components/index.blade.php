            ...
            @if(!$tournamentList->isEmpty())
                @foreach($tournamentList as $item)
                    ...
                    <div class="tournament_info">
                        ...
                        <div class="time" title="Дата начала">
                            ...
                            <span
                                    class="night_text">{{ Carbon\Carbon::parse($item->time_start)->format('H:i d.m.Y')}}</span>
                        </div>
                    ...
                    @endphp
                @endforeach
                <div id="load_more-tournament" class="gocu-replays__button night_modal">
                    <button type="button" name="load_more-tournament_button" class="button button__download-more"
                            id="load_more-tournament_button" data-id="{{ $last_id }}">
                        {{__('Загрузить еще')}}
                    </button>
                </div>
            @else
