<section class="header">
    <div class="container-fluid header_container">
        <div class="row header_row">
            ...
            <div class=" col-xl-3 col-lg-2 col-md-3 col-sm-3 col-9  logo"><img src="{{ url('/images/logo.png') }}" alt="logo"></div>
            <div class="col-xl-1 col-lg-1 col-1 mode">
                <button >
                    <svg class="day" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <button >
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="moon" class="night svg-inline--fa fa-moon fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="white" d="M283.211 512c78.962 0 151.079-35.925 198.857-94.792 7.068-8.708-.639-21.43-11.562-19.35-124.203 23.654-238.262-71.576-238.262-196.954 0-72.222 38.662-138.635 101.498-174.394 9.686-5.512 7.25-20.197-3.756-22.23A258.156 258.156 0 0 0 283.211 0c-141.309 0-256 114.511-256 256 0 141.309 114.511 256 256 256z"></path></svg>
                </button>
            </div>
