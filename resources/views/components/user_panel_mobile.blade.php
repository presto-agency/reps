<section class="user_bar">
    ...
    <div class="panel">
        <div class="block_svg">
            ...
            <a href="#" id='settings_mob' title="Настройки">
            ...
            <b href="#" onclick="event.preventDefault(); document.getElementById('logout-form-home-front').submit();"
               title="Выход">
            ...
            <form id="logout-form-home-front" action="{{ route('logout') }}" method="POST" style="display: none;">
                @csrf
            </form>
        </div>
    </div>
    <div id="settings_div_mob" class="logged_links">
