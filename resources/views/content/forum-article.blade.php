...
{{--            </div>--}}
        ...
        <div class="counter_autorization">
            <div class="block_nameArticle">
                <span class="item">Темы:<span class="text">41545</span ></span>
                <span class="item">Ответов:<span class="text">226</span></span>
            </div>
        </div>
        @if($section->topics)
