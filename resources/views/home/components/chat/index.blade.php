            ...
            <div class="block_stream_list">
                <div class="title_video ">
                    ...
                    <div class="video_header">
                        <div class="left_block">
                            ...
                            <img class="icon_bars" id="streamOnlineFlag" src="" title="" alt="flag"/>
                            <img class="icon_bars" id="streamOnlineRace" src="" title="" alt="race"/>
                ...
                <div class="video_twitch">
                    <iframe id="streamOnline" style="width: 99%; height: 100%;" allowfullscreen="true" scrolling="no"
                            autoplay="true" frameborder="0" src=""></iframe>
                </div>
            </div>
        </div>
    </div>
