    ...
    <div class="wrapper">
        <div class=" title_block">
            ...
            <div class="right_block">
                <a href="#">{{$replay->users->name}}</a>
                <img class="icon_bars"
                     src="{{\File::exists($replay->users->avatar) === true ? asset($replay->users->avatar) : asset($replay->users->avatar_url_or_blank)}}"/>
                <span>{{$replay->users->count_positive - $replay->users->count_negative .' кг'}}</span>
                <a href="#">{{$countUserPts .' pts'}}</a>
            </div>
        </div>
        ...
        <div class="replay-content">
            <div class="col-xl-8 ">
                ...
                <div class="content_left">
                    ...
                    <div class="right_block">
                        <span>{{$replay->firstRaces->title.' vs '.$replay->secondRaces->title}}</span>
                    </div>
                </div>
                <div class="content_left">
                    <div class="left_block">
                    ...
                    <div class="right_block">
                        <span>{{$replay->first_location.' vs '.$replay->second_location}}</span>
                    </div>
                </div>
                <div class="content_left">
                    <div class="left_block">
