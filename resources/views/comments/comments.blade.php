                        ...
                        <div class="comments__info change_gray">
                            ...
                            @if($comment->user->races)
                                <div class="block_minerals_icons text_pts">
                                    <p class="title__text info__text" title="{{$comment->user->comments_count}}">
                                        {{$comment->user->comments_count}}</p>
                                    ...
                                    <p class="title__text info__text" title="{{$comment->user->rating}}">
                                        {{$comment->user->rating}}</p>
